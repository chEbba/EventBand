 ...
 */
class UnexpectedFormatException extends SerializerException
{
    private $format;
    ...
    public function __construct($format, $reason, \Exception $previous = null)
    {
        ...
        parent::__construct(sprintf('Unexpected data format for "%s" deserialization: %s', $format, $reason), $previous);
    }
